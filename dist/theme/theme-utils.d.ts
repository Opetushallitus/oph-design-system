...
import { OphLanguage } from '../types.js';
import { CSSProperties } from 'react';
import '@mui/material';

declare function getLocale(lang?: OphLanguage): _mui_material_locale.Localization;
declare const focusOutlineStyle: (overrides?: CSSProperties) => {
...
export { focusOutlineStyle, getLocale };
